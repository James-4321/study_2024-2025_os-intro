...
![Текст проекта](images/image1.png){ #fig:001 width=70% }

![Результат на сайте](images/image2.png){ #fig:002 width=70% }

2. Сделаем пост по прошедшей неделе.  (рис. [-@fig:003;-@fig:004])

![Текст поста по прошедшей неделе](images/image3.png){ #fig:003 width=70% }

![Результат на сайте](images/image4.png){ #fig:004 width=70% }

3. Добавим пост на тему языки научного программирования.  (рис. [-@fig:005;-@fig:006])

![Текст поста по теме языки научного программирования](images/image5.png){ #fig:005 width=70% }

![Результат на сайте](images/image6.png){ #fig:006 width=70% }
