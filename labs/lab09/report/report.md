...
![Информация о mc](images/Picture.png){#fig:001 width=70%}

Я запускала mc, изучала его структуру и меню:

![Командная оболочка mc](images/Picture1.png){#fig:002 width=70%}

 Используя управляющие клавиши я; скопировала файл README.md в домашний каталог:

![Копирование файла](images/Picture2.png){#fig:003 width=70%}

Создала файл new в ~/work/blog и удалила его: 

![Созданный файл](images/Picture3.png){#fig:004 width=70%}

![Удаление файла](images/Picture4.png){#fig:005 width=70%}

Получила информацию о размере и правах доступа на файл README.md:

![Информация о README.md](images/Picture5.png){#fig:006 width=70%}

В правой панели вывела информацию о файле. При этом я получаю больше информации чем в выводе ls:

![Информфцию о файле](images/Picture6.png){#fig:007 width=70%}

Используя возможности подменю Файл; я посмотрела содержаемые текстового файла:

![Содержаемые файла](images/Picture7.png){#fig:008 width=70%}

редактировала содержаемые текстового файла (abrt на mi): 

![Редактирование файла](images/Picture8.png){#fig:009 width=70%}

Создала новый каталог:

![создание каталога](images/Picture9.png){#fig:0010 width=70%}

и скопировала файл в ,только что созданный каталог:

![копирование файла](images/Picture10.png){#fig:0011 width=70%}

С помощью подменю команда можно найти в файловой системе файл с заданными условиями:

![файлы которые содержат gz](images/Picture11.png){#fig:0012 width=70%}

![результаты поиска](images/Picture12.png){#fig:0013 width=70%}

Исользуя подменю команда я повторила одну из предыдущих команд:

![повторение команды](images/Picture13.png){#fig:0014 width=70%}

Также перешла в домашний каталог и анализировала файл меню и файл расширения:

![Переход в домашний каталог](images/Picture14.png){#fig:0015 width=70%}

![файл расширения](images/Picture15.png){#fig:0016 width=70%}

Из подменю настройка вызвала окна настройки панели:

![Настройка панели](images/Picture16.png){#fig:0017 width=70%}

Настройки внешнего вида:

![Настройки внешнего вида](images/Picture17.png){#fig:0018 width=70%}

# Задание по встроенному редактору mc

С помощью команды touch создала text.txt:

![Создание text.txt](images/Picture19.png){#fig:0019 width=70%}

Далее открыла его для редактирования с помощью f4 и с shift ctrl ins вставила текст:

![Редактирование text.txt](images/Picture20.png){#fig:0020 width=70%}

С помощью f3 выделила текст и удалила выделеные слова f8:

![Удаление текста](images/Picture21.png){#fig:0021 width=70%}

Перемещала выделенный текст с помощью f6:

![Перемещение текста](images/Picture22.png){#fig:0022 width=70%}

Сохранила изменении с помощью f2:

![Сохранение изменений в файле](images/Picture23.png){#fig:0023 width=70%}

С помощью ctrl-u отменила последнее действие:

![Отменение последнего действия](images/Picture24.png){#fig:0024 width=70%}

Используя pg up и pg dn перешла в начало и конец файла и написала некоторый текст. Затем сохранила и закрыла файл:

![Добавление текста](images/Picture25.png){#fig:0025 width=70%}

Открыла файл с исходным текстом на cpp:

![файл cpp](images/Picture26.png){#fig:0026 width=70%}

Используя подменю команда я выключила подсветку синтаксиса:

![Подменю команда](images/Picture27.png){#fig:0027 width=70%}

![подсветка синтаксиса](images/Picture28.png){#fig:0028 width=70%}
...
10. Панель в mc отображает список файлов текущего каталога. Абсолютный путь к этому каталогу отображается в заголовке панели. У активной панели заголовок и одна из её строк
