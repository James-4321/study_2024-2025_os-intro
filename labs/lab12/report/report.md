...
![Создание project.sh ](images/image1.png){#fig:001 width=70%}

```
tar -cvf ~/backup/project.tar project.sh
```

![Скрипт](images/image2.png){#fig:002 width=70%}

![Создание исполняемого файла](images/image3.png){#fig:003 width=70%}

![Запуск файла](images/image4.png){#fig:004 width=70%}

Я проверила с помощью cat,что копия содержит скрипт из оригинала:

![Проверка копии файла](images/image5.png){#fig:005 width=70%}
...
![Создание project1.sh](images/image6.png){#fig:006 width=70%}

![Код project1.sh](images/image7.png){#fig:007 width=70%}
...
![Запуск project1.sh](images/image8.png){#fig:008 width=70%}
...
![Создание project2.sh](images/image9.png){#fig:009 width=70%}
...
![Программа project2.sh](images/image10.png){#fig:0010 width=70%}

![Запуск программы](images/image11.png){#fig:0011 width=70%}
...
![Код project3.sh](images/image13.png){#fig:0013 width=70%}
...
![Запуск project3.sh](images/image12.png){#fig:0012 width=70%}
