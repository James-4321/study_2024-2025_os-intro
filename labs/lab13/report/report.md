...
Bash широко используется в средах Unix и Linux, а также поддерживается Windows с помощью подсистемы Windows для Linux (WSL). Перечислим основные возможности этой оболочки.
    ...
    Возможность создания и запуска скриптов. Скрипты оболочки — это текстовые файлы, содержащие последовательность команд. Их можно создавать с помощью текстового редактора, а затем запускать в терминале, что дает возможность пользователям автоматизировать зада
...
![Код для анализирования командной строки](images/image1.png){#fig:001 width=70%}
...
![право на исполнение](images/image2.png){#fig:002 width=70%}

![Запуск file1](images/image3.png){#fig:003 width=70%}
...
![Программа на языке Си](images/image4.png){#fig:004 width=70%}
...
![Командный файл программы на Си](images/image5.png){#fig:005 width=70%}
...
![Результаты программы](images/image6.png){#fig:006 width=70%}
...
![Командный файл для создания файлов](images/image7.png){#fig:007 width=70%}
...
![Создание файлов с помощью командного файла](images/image8.png){#fig:008 width=70%}
...
![Создание архива](images/image9.png){#fig:009 width=70%}
...
![Результаты кода](images/image10.png){#fig:0010 width=70%}
